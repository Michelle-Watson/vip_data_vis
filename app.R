...
custom_definitions <- tribble(
  ...
  "HR"                                                                      , "High‑risk (broader than immunocompromised; includes other chronic conditions)"                                                                                                                                                                                                                  ,
  "P"                                                                       , "Pregnant individuals (and infants born after vaccination during pregnancy)"                                                                                                                                                                                                                     ,
  "H"                                                                       , "Healthcare personnel"                                                                                                                                                                                                                                                                           ,
  "Study Period"                                                            , "From first enrollment to last enrollment (MM/YYYY–MM/YYYY)"                                                                                                                                                                                                                                     ,
  "Total N"                                                                 , "Total sample size (may be number of participants, mother‑infant pairs, or reports)"                                                                                                                                                                                                             ,
  "Estimate (95% CI)"                                                       , "Point estimate with 95% confidence interval; NE = not estimable, NR = not reported"                                                                                                                                                                                                             ,
  "Factors Adjusted"                                                        , "Variables included in adjusted model; Unadjusted = no adjustment, NA (RCT) = randomized trial with no adjustment required, - = estimate not calculable or not reported"                                                                                                                         ,
  "Subgroup letter (e.g., Choi 2026e)"                                      , "Appended to study label when a row reports on a subgroup that is already part of another row for the same outcome – alerts reader to avoid double‑counting"                                                                                                                                     ,
  ...
  "High‑risk"                                                               , "Other co-occurring conditions (broader than immunocompromised; includes other chronic conditions)"                                                                                                                                                                                              ,
  ...
  "Estimate Type"                                                           , "Type of estimate (e.g., OR = Odds Ratio, VE = Vaccine Effectiveness, HR = Hazard Ratio, RR = Risk Ratio, IRR = Incidence Rate Ratio, TR = Time Ratio, CR = Cum­ulative Risk). NR if not reported."                                                                                              ,
  ...
  "AIRD"                                                                    , "autoimmune rheumatic diseases"                                                                                                                                                                                                                                                                  ,
  ...
  "Tdap/Td"                                                                 , "diphtheria, tetanus and (acellular) pertussis/diphtheria and tetanus"                                                                                                                                                                                                                           ,
  ...
  "CAN score"                                                               , "The Veterans Health Administration Care Assessment Need score"                                                                                                                                                                                                                                  ,
  "ER"                                                                      , "emergency room"                                                                                                                                                                                                                                                                                 ,
  ...
  "US Flu VE"                                                               , "US Flu Vaccine Effectiveness registry"                                                                                                                                                                                                                                                          ,
  "NVSN"                                                                    , "New Vaccine Surveillance Network"                                                                                                                                                                                                                                                               ,
  "VISION"                                                                  , "Virtual SARS-CoV-2, Influenza, and Other Respiratory Viruses Network registry"                                                                                                                                                                                                                  ,
  ...
  "HD-IIV4"                                                                 , "high-dose quadrivalent inactivated influenza vaccine"                                                                                                                                                                                                                                           ,
  "allV4"                                                                   , "adjuvanted quadrivalent inactivated influenza vaccine"                                                                                                                                                                                                                                          ,
  ...
  tabsetPanel(
    tabPanel(
      ...
      tags$div(
        ...
        # ),
        tags$p(
          "Questions or feedback about the data tool? mail [at]",
          tags$a(
